...
//正则匹配的选项
const int SPREG_DEFAULT       = 0;		                  /**< 默认选项                        */
const int SPREG_CASELESS      = PCRE_CASELESS;		      /**< 忽略大小写                      */
const int SPREG_MULTILINE	  = PCRE_MULTILINE;		      /**< 采用多行模式，^ $可以匹配\r\n   */
const int SPREG_DOTALL        = PCRE_DOTALL;		      /**< .号可以匹配\r\n                 */
const int SPREG_NOTBOL		  = PCRE_NOTBOL;		      /**< ^不匹配串开头                   */
const int SPREG_NOTEOL		  = PCRE_NOTEOL;		      /**< $不匹配串末尾                   */
const int SPREG_UNGREEDY	  = PCRE_UNGREEDY;		      /**< 非贪婪模式                      */
const int SPREG_NOTEMPTY      = PCRE_NOTEMPTY;            /**< 匹配时不匹配空串                */
const int SPREG_UTF8		  = PCRE_UTF8;			      /**< UTF8模式                        */
const int SPREG_NO_UTF8_CHECK = PCRE_NO_UTF8_CHECK;	      /**< 使用UTF8模式但不检查UTF8是否合法*/
