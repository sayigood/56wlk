...
namespace var{
    ...
    */
    template<template<class>class Alloc>
        class __MagicGnuHashMapAdapter: public __gnu_cxx::hash_map<IVar::string_type, bsl::var::MagicRef, __gnu_cxx::hash<IVar::string_type>, std::equal_to<IVar::string_type>, Alloc<bsl::var::MagicRef> > {
        public:
            typedef __gnu_cxx::hash_map<IVar::string_type, bsl::var::MagicRef, __gnu_cxx::hash<IVar::string_type>, std::equal_to<IVar::string_type>, Alloc<bsl::var::MagicRef> > base_type;
            typedef typename base_type::allocator_type  allocator_type;
            typedef typename base_type::iterator        iterator;
            typedef typename base_type::const_iterator  const_iterator;
