    ...
    */
    ...
    public:
        ...
        **/
        Exception()
            :base_type(){
                stack_trace(_stack, _s_stack_trace_level);
            }
    ...
    protected:
         ...
         * @param [in] total_level   : size_t 打出的总层数，默认为DEFAULT_STACK_TRACE_LEVEL
         * @param [in] begin_level   : size_t 跳过栈顶的begin_level层,默认值为不打印stack_trace()本身
         * @return  void 
         * @retval   
         * @see 
        **/
        static void stack_trace( AutoBuffer& buf, size_t total_level = DEFAULT_STACK_TRACE_LEVEL, size_t begin_level = 1);
         ...
         * @see 
        **/
        static void demangle( AutoBuffer& buf, const char * mangled_name );
