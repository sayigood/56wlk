...
namespace bsl{
    ...
    */
    ...
    public:
        ...
        **/
        ResourcePool()
            :_syspool(), _mempool(_syspool), _p_attach_object_list(NULL), _p_attach_array_list(NULL), _p_alloc_object_list(NULL), _p_alloc_array_list(NULL){}
        ...
        **/
        explicit ResourcePool( mempool& pool )
            :_mempool(pool), _p_attach_object_list(NULL), _p_attach_array_list(NULL), _p_alloc_object_list(NULL), _p_alloc_array_list(NULL){}
        ...
        **/
        template<typename T, typename T_arg1, typename T_arg2, typename T_arg3 >
            T& create( const T_arg1& arg1, const T_arg2& arg2, const T_arg3 arg3 ){
                return _create_object<T>( ThreeConstArgCtor<T,T_arg1,T_arg2,T_arg3>(arg1, arg2, arg3) );
            }
        ...
        **/
        template<typename T, typename T_arg1, typename T_arg2, typename T_arg3, typename T_arg4 >
            T& create( const T_arg1& arg1, const T_arg2& arg2, const T_arg3 arg3, const T_arg4 arg4 ){
                return _create_object<T>( FourConstArgCtor<T, T_arg1, T_arg2, T_arg3, T_arg4>(arg1, arg2, arg3, arg4) );
            }

        template<typename T, typename T_arg1, typename T_arg2, typename T_arg3, typename T_arg4 >
            T* createp( const T_arg1& arg1, const T_arg2& arg2, const T_arg3 arg3, const T_arg4 arg4 ){
                try{
                    return &_create_object<T>( FourConstArgCtor<T, T_arg1, T_arg2, T_arg3, T_arg4>(arg1, arg2, arg3, arg4) );
                }catch(...){
                    return NULL;
        ...
        template<typename T>
            T* create_array( size_t n ){
                ...
                try{
                    ...
                    if ( !begin ){
                        throw bsl::BadAllocException()<<BSL_EARG<<"_mempool["<<&_mempool<<"] size["<<n * sizeof(T)<<"]";
                    }
                    try{
        ...
        **/
        void * create_raw( size_t bytes ){ 
            ...
            try{
                ...
                if ( !res ){
                    throw bsl::BadAllocException()<<BSL_EARG<<"_mempool["<<&_mempool<<"] size["<<bytes<<"]";
                }
                info.begin      = res;
                info.end        = res+bytes;
        ...
        **/
         ...
         * @see 
        **/
        const char * crcprintf_hint( size_t hint_capacity, const char * format, ... )__attribute__ ((format (printf, 3, 4) ));
    ...
    private:
        ...
        */
        ...
        template<typename T, typename Arg1T, typename Arg2T, typename Arg3T, typename Arg4T>
            ...
            public:
                FourConstArgCtor( const Arg1T& arg1, const Arg2T& arg2, const Arg3T& arg3, const Arg4T& arg4 )
        ...
        template<typename T, typename CtorT>
            T& _create_object( const CtorT& ctor ){
                ...
                try{
                    ...
                    if ( !p_object ){
                        throw bsl::BadAllocException()<<BSL_EARG<<"_mempool["<<&_mempool<<"] size["<<sizeof(T)<<"]";
                    }
                    try{
    ...
    private:
        ...
        **/
        ...
        info_t& _push_info( block_list_node_t<info_t> *& p_list_head ){
            if ( NULL!=p_list_head && p_list_head->current < _S_ITEMS_PER_NODE - 1 ){
                ...
                if ( !p_tmp ){
                    throw bsl::BadAllocException()<<BSL_EARG<<"_mempool["<<&_mempool<<"] size["<<sizeof(node_t)<<"]";
                }
        ...
        **/
         ...
         * @see 
        **/
        const char * _vprintf( alloc_array_info_t& info, size_t hint_capacity, const char *format, va_list ap );
        /**
