 ...
 * @see 
**/
int com_openlog(const char *procname, com_device_t *dev, int dev_num, com_logstat_t *stat, bool force=0);//´ò¿ªÈÕÖ¾£¬²¢Ö¸¶¨ÈÕÖ¾µÈ¼¶£¬ºÍÊä³öµÄÈÕÖ¾Éè±¸
 ...
 * @see 
**/
int com_loadlog(const char *path, const char *file, bool force=0);
